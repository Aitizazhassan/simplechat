...
if (isset ( $_POST ['enter'] )) {
    if ($_POST ['name'] != "") {
       ...
       ?>
       <script>alert('Please Enter The Name to start live chat')</script>
       <?php
        echo '<span class="error">Please Enter a Name</span>';
        // $errormsggg = '<span class="error">Please Enter a Name</span>';
...
<html>
<head>
	<title>Live Chat Using PHP and Javascript</title>
...
<button type="button" class="cancel" style="display:none;">Close</button>
<?php
